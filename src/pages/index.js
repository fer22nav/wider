    ...
    <>
      ...
      <section>
        <div className="image-container">
          ...
          <p>Chief Accessibility Officer. W3C Invited Expert. CPWA, WAS, CPACC.</p>
        </div>
        <div className="image-container">
          {/* <img src="imagen1.jpg" alt="Descripción de la imagen 1" /> */}
          <p>Diseñadora UX/UI. Especialista en accesibilidad digital. CPACC.</p>
        </div>
        <a href='#'>Conocer al equipo</a>
      ...
      <section>
        ...
        <p>Estamos en Argentina, España y Estados Unidos, pero brindamos nuestros servicios para cualquier lugar del mundo. Trabajamos en forma remota, online y en varios idiomas. </p>
      ...
      <section>
        ...
        <p>clientes de + de 30 países +200 demandas revisadas +10 mil personas capacitadas</p>
      </section>
      <section>
